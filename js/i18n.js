...
(function () {
  ...
  var DICT = {
    ...
    zh: {
      ...
      "sel.title": "近期研究",
      "sel.note": "以下是三项近期工作的详细介绍。<sup>*</sup> 表示第一作者。",
      ...
      "pubs.title": "论文发表",
      "pubs.note": "此处为部分代表性论文，完整列表请见 <a href=\"https://scholar.google.com/citations?user=jRcFD0MAAAAJ\">Google Scholar</a>。<sup>*</sup> 表示第一作者。",
      "pubs.conf": "国际会议",
      "pubs.jour": "期刊论文",
      "pubs.pre": "预印本",
    ...
    ja: {
      ...
      "sel.title": "最近の研究",
      "sel.note": "近年の代表的な 3 件を詳しく紹介します。<sup>*</sup> は筆頭著者を表します。",
      ...
      "pubs.title": "研究業績",
      "pubs.note": "主要な論文のみを掲載しています。全リストは <a href=\"https://scholar.google.com/citations?user=jRcFD0MAAAAJ\">Google Scholar</a> をご覧ください。<sup>*</sup> は筆頭著者を表します。",
      "pubs.conf": "国際会議",
      "pubs.jour": "学術誌論文",
      "pubs.pre": "プレプリント",
